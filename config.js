...
module.exports = {
    ...
    ANTI_SPAM: process.env.ANTI_SPAM || '923447640558-1632403322@g.us',
    ...
    RG: process.env.RG || '923447640558-1632403322@g.us',
    BOT_INFO: process.env.BOT_INFO || 'DarkDevil;hassan;923447640558;https://i.imgur.com/',
    RBG_KEY: process.env.RBG_KEY || '',
    ALLOWED: process.env.ALLOWED || '92',
    CHATBOT: process.env.CHATBOT || 'off',
    HANDLERS: process.env.HANDLERS || '.,',
    STICKER_DATA: process.env.STICKER_DATA,
    BOT_NAME: process.env.BOT_NAME || 'DevilDark',
    AUDIO_DATA: process.env.AUDIO_DATA === undefined || process.env.AUDIO_DATA === "private" ? 'ꪶ͢٭*Hassan¹¹ꫂ;DevilDark MD bot;https://www.linkpicture.com/q/rgnk.jpg' : process.env.AUDIO_DATA,
